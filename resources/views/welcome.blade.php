...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="h-[550px] overflow-hidden bg-slate-300">
                <div
                    class="md:p-5 flex hover:justify-end group/left group/imgs skew-x-0 hover:-skew-y-0 ">

                    <div
                        class="w-0 absolute -left-0 group-hover/left:w-1/3 group-hover/left:visible invisible text-white transition-all ease-in-out">
                        <h1 class="text-4xl">Spesial untuk Seniman ARTIKNESIA</h1>
                        <div class="grid grid-cols-2 *:rounded-md gap-3 mt-10">
                            <div class="p-3 w-full h-fit flex flex-col justify-center items-center bg-white text-black">
                                <div class=" w-full max-w-32 h-full"  id="animation container">
                                    <script>
                            ...
                            <div class="p-3 w-full h-fit flex flex-col justify-center items-center bg-white text-black">
                                <div class="w-full h-full"  id="animation container2">
                                    <script>
                                        var animation = bodymovin.loadAnimation({
                                            container: document.getElementById('animation container2'),
                                            path: '{{ asset('assets/animations/animation-custom-art.json') }}',
                                            render: 'svg',
                                            loop: true,
                                            autoplay: true,
                                            name: 'intro'
                            ...
                            <div class="p-3 w-full h-fit flex flex-col justify-center items-center bg-white text-black">
                                <div class=" w-full max-w-32 h-full"  id="animation container3">
                                    <script>
                                        var animation = bodymovin.loadAnimation({
                            ...
                            <div class="p-3 w-full h-fit flex flex-col justify-center items-center bg-white text-black">
                                <div class=" w-full max-w-32 h-full"  id="animation container4">
                                    <script>
                                        var animation = bodymovin.loadAnimation({
                    ...
                    <div
                        class="w-full group-hover/imgs:w-1/2 group-hover/imgs:gap-2 group-hover/imgs:-mt-20 -skew-x-0 transition-all duration-700 ease-in-out columns-1 gap-5 lg:gap-8 sm:columns-2 lg:columns-3 xl:columns-4 [&>img:not(:first-child)]:mt-5 group-hover/imgs:lg:[&>img:not(:first-child)]:mt-2 lg:[&>img:not(:first-child)]:mt-8 *:rounded-md">
                        <img src="https://source.unsplash.com/ztpUS4N1xhY" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/mPFSPqZOO7s" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/uPEnxrdSKIw" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/hFKZ5-OT9Ys" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/xoTt2fjs7d0" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/Vc2dD4l57og" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/hqnQWmIt3cY" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/NTGg2rtWDwg" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/uyX3qAQhZVA" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/LV-NvIcA-Gg" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/0qnRfgnZIsI" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/mpwF3Mv2UaU" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/gfMWhkDCwYM" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/8KtqjrskUg8" alt="" loading="lazy"/>
                        <img src="https://source.unsplash.com/qAaGXj-AOv4" alt="" loading="lazy"/>
                    </div>
                </div>
            </div>
