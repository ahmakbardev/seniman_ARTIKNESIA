...
@section('seniman_content')
    <div class="-mt-20 w-full mx-auto mb-5 p-6">
        ...
        <div class="card shadow-lg p-6">
            <form action="{{ route('seniman.karya.update', ['karya' => $karya->id, 'locale' => app()->getLocale()]) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="block text-sm">
                        ...
                        <input name="name" value="{{ old('name', $karya->name) }}"
                    ...
                    <label class="block text-sm">
                        <p class="text-gray-800">Gambar Karya <span class="text-primary">(bisa lebih dari 1 gambar)</span>
                        </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="block text-sm">
                        ...
                        <input name="size_x" type="number" id="size_x" value="{{ old('size_x', $karya->size_x) }}"
                            class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
                    ...
                    <label class="block text-sm">
                        ...
                        <input name="size_y" type="number" id="size_y" value="{{ old('size_y', $karya->size_y) }}"
                            class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="block text-sm">
                        ...
                        <input name="weight" type="number" id="weight" value="{{ old('weight', $karya->weight) }}"
                            class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
                    ...
                    <label class="block text-sm">
                        ...
                        <input name="material" type="text" id="material"
                            value="{{ old('material', $karya->material) }}"
                            class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
                            placeholder="Kanvas" />
                        @error('material')
                            <span class="text-red-500">{{ $message }}</span>
                ...
                <label class="block text-sm">
                    ...
                    <textarea name="philosophy" id="philosophy" rows="3"
                        class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
                        style="resize: none" placeholder="Tulis filosofi karyamu disini ...">{{ old('philosophy', $karya->philosophy) }}</textarea>
                    @error('philosophy')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </label>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="block text-sm">
                        ...
                        <div class="relative">
                            ...
                            <input name="price" type="text" id="priceInput" value="{{ old('price', $karya->price) }}"
                    ...
                    <label class="block text-sm">
                        ...
                        <input name="stock" type="number" id="stock" value="{{ old('stock', $karya->stock) }}"
                            class="block w-full border mt-1 text-sm border-gray-300 p-3 rounded-md bg-white focus:border-primary focus:outline-none focus:shadow-outline-primary text-gray-700 focus:shadow-outline-gray form-input"
