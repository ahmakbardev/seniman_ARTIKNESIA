        ...
        <div class="xl:col-span-2">
            <div class="card h-full shadow">
                ...
                <div class="border-b border-gray-300 px-5 py-4">
                    <h4 class="font-semibold">My Products</h4>
                </div>
                    ...
                    <table class="text-left w-full whitespace-nowrap">
                        ...
                        <tbody>
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-1.svg') }}" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-2.svg') }}" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-3.svg') }}" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-4.svg') }}" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-5.svg') }}" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/svg/brand-logo-6.svg') }}" alt=""
                                            class="h-6 w-6" />
                                ...
                                <div class="flex items-center">
                                    <div>
                                        <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Image"
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div>
                                        <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Image"
                                                class="rounded-full" /></a>
                                    </div>
                                    <div class="ml-3 leading-4">
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div>
                                        <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Image"
                                                class="rounded-full" /></a>
                                    </div>
                                    <div class="ml-3 leading-4">
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div>
                                        <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Image"
                                                class="rounded-full" /></a>
                                    </div>
                                    <div class="ml-3 leading-4">
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div>
                                        <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Image"
                                                class="rounded-full" /></a>
                                    </div>
                                    <div class="ml-3 leading-4">
                                        <h5 class="mb-1"><a href="#!">Patricia Murrill</a></h5>
