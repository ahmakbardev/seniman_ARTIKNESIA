                            ...
                            @foreach ($negotiationBatches as $item)
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <h5 class="mb-1 ml-4">{{ $item->name }}</h5>
                                    </div>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-xl transform transition-all sm:max-w-lg sm:w-full mx-4">
            <div class="bg-white p-6 rounded-md shadow-lg relative">
                ...
                <div class="space-y-4">
                    ...
                    <div id="karyaMessage"
                         class="text-red-500 hidden p-3 border-red-500 bg-red-50 text-sm rounded-lg mt-4">
                ...
                <div class="flex justify-end mt-6">
                    <button class="bg-primary text-white px-4 py-2 rounded mr-2"
                            onclick="window.location.href='{{ url('id/seniman/karya/edit') }}/' + document.getElementById('karyaId').value">
                        Edit
                    </button>
                    <button class="bg-gray-500 text-white px-4 py-2 rounded"
                            onclick="closeKaryaDetailModal()">Close
                    </button>
                </div>
            </div>
        </div>
